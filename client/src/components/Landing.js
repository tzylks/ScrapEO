        ...
        <>
            ...
            <Parallax ref={parallax} pages={5.5} style={{ top: '0', left: '0' }}>
                <ParallaxLayer horizontal config={{ friction: 20 }} onClick={() => parallax.current.scrollTo(1.5)} factor={2.4} offset={0} speed={1} style={{ background: '#9C19E0', opacity: 1 }}>
                    ...
                    <Typography variant='h1' style={{ fontSize: '6rem', position: 'absolute', top: 580, left: 341, fontFamily: "'Bowlby One SC', cursive", color: 'white' }}>Click to Scroll</Typography>
                </ParallaxLayer>
                ...
                <ParallaxLayer horizontal factor={2} offset={1.5} speed={1} style={{ backgroundColor: '#FFEF78' }}>
                    ...
                    <Typography variant='h1' style={{ color: "black", fontSize: '2.7rem', position: 'absolute', top: 2790, left: 320, fontFamily: "'Bowlby One SC', cursive", color: 'black' }}>Click Scroll Disabled -- Use Mouse</Typography>
